                        ...
                        <form className='h-full overflow-y-auto px-3 mb-5' action=''>
                          ...
                          <div className='flex justify-between flex-row'>
                            <div className=''>
                              ...
                              <Input
                                label={"Company Phone"}
                                handleChange={props.handleChange("company.phone")}
                                name={"phone"}
                                placeholder='0244123456'
                                error={props.touched.company && props.errors.company}
                                value={props.values.company.phone}
                              />
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                handleChange={props.handleChange("customer.phone")}
                                name={"customer-phone"}
                                placeholder='0244123456'
                                error={props.touched.customer && props.errors.customer}
                                value={props.values.customer.phone}
                              />
